# Basic Full Text Search for SilverBullet
Previously a built-in plug for SilverBullet, now installable separately for those who don’t want to use Silversearch. 
